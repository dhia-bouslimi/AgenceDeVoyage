...
class CategoryController extends AbstractController
{
    ...
    public function index(): Response
    {
        ...
        return $this->render('clientt/categorie/listCategorie.html.twig',array('categories'=>$res));
    }
    ...
    public function showProducts(\Symfony\Component\HttpFoundation\Request $req, $id)
    {
       ...
       // var_dump($categorie); die();
        ...
        return $this->render('clientt/categorie/showProductsByCat.html.twig', array('products'=>$product,'namecar'=>$categorie->getName()
