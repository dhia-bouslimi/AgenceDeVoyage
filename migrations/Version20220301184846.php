 ...
 */
final class Version20220301184846 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD etat TINYINT(1) DEFAULT NULL, ADD note INT DEFAULT NULL');
    }
