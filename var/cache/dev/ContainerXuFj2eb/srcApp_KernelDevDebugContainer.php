...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('I1-qupB8p4', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('z9-Rlhv-qg', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('bLW6oSzFYw', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('rqs4lTcdZx', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('vD9dsdHsMF', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('bmYTrdLKF8', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('FP1ay8S1rF', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolderf0992 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer6e0ac = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties17a60 = [
        
    ];

    public function getConnection()
    {
        $this->initializer6e0ac && ($this->initializer6e0ac->__invoke($valueHolderf0992, $this, 'getConnection', array(), $this->initializer6e0ac) || 1) && $this->valueHolderf0992 = $valueHolderf0992;

        return $this->valueHolderf0992->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer6e0ac && ($this->initializer6e0ac->__invoke($valueHolderf0992, $this, 'getMetadataFactory', array(), $this->initializer6e0ac) || 1) && $this->valueHolderf0992 = $valueHolderf0992;

        return $this->valueHolderf0992->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer6e0ac && ($this->initializer6e0ac->__invoke($valueHolderf0992, $this, 'getExpressionBuilder', array(), $this->initializer6e0ac) || 1) && $this->valueHolderf0992 = $valueHolderf0992;

        return $this->valueHolderf0992->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer6e0ac && ($this->initializer6e0ac->__invoke($valueHolderf0992, $this, 'beginTransaction', array(), $this->initializer6e0ac) || 1) && $this->valueHolderf0992 = $valueHolderf0992;

        return $this->valueHolderf0992->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer6e0ac && ($this->initializer6e0ac->__invoke($valueHolderf0992, $this, 'getCache', array(), $this->initializer6e0ac) || 1) && $this->valueHolderf0992 = $valueHolderf0992;

        return $this->valueHolderf0992->getCache();
    }

    public function transactional($func)
    {
        $this->initializer6e0ac && ($this->initializer6e0ac->__invoke($valueHolderf0992, $this, 'transactional', array('func' => $func), $this->initializer6e0ac) || 1) && $this->valueHolderf0992 = $valueHolderf0992;

        return $this->valueHolderf0992->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializer6e0ac && ($this->initializer6e0ac->__invoke($valueHolderf0992, $this, 'wrapInTransaction', array('func' => $func), $this->initializer6e0ac) || 1) && $this->valueHolderf0992 = $valueHolderf0992;

        return $this->valueHolderf0992->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializer6e0ac && ($this->initializer6e0ac->__invoke($valueHolderf0992, $this, 'commit', array(), $this->initializer6e0ac) || 1) && $this->valueHolderf0992 = $valueHolderf0992;

        return $this->valueHolderf0992->commit();
    }

    public function rollback()
    {
        $this->initializer6e0ac && ($this->initializer6e0ac->__invoke($valueHolderf0992, $this, 'rollback', array(), $this->initializer6e0ac) || 1) && $this->valueHolderf0992 = $valueHolderf0992;

        return $this->valueHolderf0992->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer6e0ac && ($this->initializer6e0ac->__invoke($valueHolderf0992, $this, 'getClassMetadata', array('className' => $className), $this->initializer6e0ac) || 1) && $this->valueHolderf0992 = $valueHolderf0992;

        return $this->valueHolderf0992->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer6e0ac && ($this->initializer6e0ac->__invoke($valueHolderf0992, $this, 'createQuery', array('dql' => $dql), $this->initializer6e0ac) || 1) && $this->valueHolderf0992 = $valueHolderf0992;

        return $this->valueHolderf0992->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer6e0ac && ($this->initializer6e0ac->__invoke($valueHolderf0992, $this, 'createNamedQuery', array('name' => $name), $this->initializer6e0ac) || 1) && $this->valueHolderf0992 = $valueHolderf0992;

        return $this->valueHolderf0992->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer6e0ac && ($this->initializer6e0ac->__invoke($valueHolderf0992, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer6e0ac) || 1) && $this->valueHolderf0992 = $valueHolderf0992;

        return $this->valueHolderf0992->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer6e0ac && ($this->initializer6e0ac->__invoke($valueHolderf0992, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer6e0ac) || 1) && $this->valueHolderf0992 = $valueHolderf0992;

        return $this->valueHolderf0992->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer6e0ac && ($this->initializer6e0ac->__invoke($valueHolderf0992, $this, 'createQueryBuilder', array(), $this->initializer6e0ac) || 1) && $this->valueHolderf0992 = $valueHolderf0992;

        return $this->valueHolderf0992->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer6e0ac && ($this->initializer6e0ac->__invoke($valueHolderf0992, $this, 'flush', array('entity' => $entity), $this->initializer6e0ac) || 1) && $this->valueHolderf0992 = $valueHolderf0992;

        return $this->valueHolderf0992->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer6e0ac && ($this->initializer6e0ac->__invoke($valueHolderf0992, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer6e0ac) || 1) && $this->valueHolderf0992 = $valueHolderf0992;

        return $this->valueHolderf0992->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer6e0ac && ($this->initializer6e0ac->__invoke($valueHolderf0992, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer6e0ac) || 1) && $this->valueHolderf0992 = $valueHolderf0992;

        return $this->valueHolderf0992->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer6e0ac && ($this->initializer6e0ac->__invoke($valueHolderf0992, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer6e0ac) || 1) && $this->valueHolderf0992 = $valueHolderf0992;

        return $this->valueHolderf0992->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer6e0ac && ($this->initializer6e0ac->__invoke($valueHolderf0992, $this, 'clear', array('entityName' => $entityName), $this->initializer6e0ac) || 1) && $this->valueHolderf0992 = $valueHolderf0992;

        return $this->valueHolderf0992->clear($entityName);
    }

    public function close()
    {
        $this->initializer6e0ac && ($this->initializer6e0ac->__invoke($valueHolderf0992, $this, 'close', array(), $this->initializer6e0ac) || 1) && $this->valueHolderf0992 = $valueHolderf0992;

        return $this->valueHolderf0992->close();
    }

    public function persist($entity)
    {
        $this->initializer6e0ac && ($this->initializer6e0ac->__invoke($valueHolderf0992, $this, 'persist', array('entity' => $entity), $this->initializer6e0ac) || 1) && $this->valueHolderf0992 = $valueHolderf0992;

        return $this->valueHolderf0992->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer6e0ac && ($this->initializer6e0ac->__invoke($valueHolderf0992, $this, 'remove', array('entity' => $entity), $this->initializer6e0ac) || 1) && $this->valueHolderf0992 = $valueHolderf0992;

        return $this->valueHolderf0992->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer6e0ac && ($this->initializer6e0ac->__invoke($valueHolderf0992, $this, 'refresh', array('entity' => $entity), $this->initializer6e0ac) || 1) && $this->valueHolderf0992 = $valueHolderf0992;

        return $this->valueHolderf0992->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer6e0ac && ($this->initializer6e0ac->__invoke($valueHolderf0992, $this, 'detach', array('entity' => $entity), $this->initializer6e0ac) || 1) && $this->valueHolderf0992 = $valueHolderf0992;

        return $this->valueHolderf0992->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer6e0ac && ($this->initializer6e0ac->__invoke($valueHolderf0992, $this, 'merge', array('entity' => $entity), $this->initializer6e0ac) || 1) && $this->valueHolderf0992 = $valueHolderf0992;

        return $this->valueHolderf0992->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer6e0ac && ($this->initializer6e0ac->__invoke($valueHolderf0992, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer6e0ac) || 1) && $this->valueHolderf0992 = $valueHolderf0992;

        return $this->valueHolderf0992->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer6e0ac && ($this->initializer6e0ac->__invoke($valueHolderf0992, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer6e0ac) || 1) && $this->valueHolderf0992 = $valueHolderf0992;

        return $this->valueHolderf0992->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer6e0ac && ($this->initializer6e0ac->__invoke($valueHolderf0992, $this, 'getRepository', array('entityName' => $entityName), $this->initializer6e0ac) || 1) && $this->valueHolderf0992 = $valueHolderf0992;

        return $this->valueHolderf0992->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer6e0ac && ($this->initializer6e0ac->__invoke($valueHolderf0992, $this, 'contains', array('entity' => $entity), $this->initializer6e0ac) || 1) && $this->valueHolderf0992 = $valueHolderf0992;

        return $this->valueHolderf0992->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer6e0ac && ($this->initializer6e0ac->__invoke($valueHolderf0992, $this, 'getEventManager', array(), $this->initializer6e0ac) || 1) && $this->valueHolderf0992 = $valueHolderf0992;

        return $this->valueHolderf0992->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer6e0ac && ($this->initializer6e0ac->__invoke($valueHolderf0992, $this, 'getConfiguration', array(), $this->initializer6e0ac) || 1) && $this->valueHolderf0992 = $valueHolderf0992;

        return $this->valueHolderf0992->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer6e0ac && ($this->initializer6e0ac->__invoke($valueHolderf0992, $this, 'isOpen', array(), $this->initializer6e0ac) || 1) && $this->valueHolderf0992 = $valueHolderf0992;

        return $this->valueHolderf0992->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer6e0ac && ($this->initializer6e0ac->__invoke($valueHolderf0992, $this, 'getUnitOfWork', array(), $this->initializer6e0ac) || 1) && $this->valueHolderf0992 = $valueHolderf0992;

        return $this->valueHolderf0992->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer6e0ac && ($this->initializer6e0ac->__invoke($valueHolderf0992, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer6e0ac) || 1) && $this->valueHolderf0992 = $valueHolderf0992;

        return $this->valueHolderf0992->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer6e0ac && ($this->initializer6e0ac->__invoke($valueHolderf0992, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer6e0ac) || 1) && $this->valueHolderf0992 = $valueHolderf0992;

        return $this->valueHolderf0992->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer6e0ac && ($this->initializer6e0ac->__invoke($valueHolderf0992, $this, 'getProxyFactory', array(), $this->initializer6e0ac) || 1) && $this->valueHolderf0992 = $valueHolderf0992;

        return $this->valueHolderf0992->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer6e0ac && ($this->initializer6e0ac->__invoke($valueHolderf0992, $this, 'initializeObject', array('obj' => $obj), $this->initializer6e0ac) || 1) && $this->valueHolderf0992 = $valueHolderf0992;

        return $this->valueHolderf0992->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer6e0ac && ($this->initializer6e0ac->__invoke($valueHolderf0992, $this, 'getFilters', array(), $this->initializer6e0ac) || 1) && $this->valueHolderf0992 = $valueHolderf0992;

        return $this->valueHolderf0992->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer6e0ac && ($this->initializer6e0ac->__invoke($valueHolderf0992, $this, 'isFiltersStateClean', array(), $this->initializer6e0ac) || 1) && $this->valueHolderf0992 = $valueHolderf0992;

        return $this->valueHolderf0992->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer6e0ac && ($this->initializer6e0ac->__invoke($valueHolderf0992, $this, 'hasFilters', array(), $this->initializer6e0ac) || 1) && $this->valueHolderf0992 = $valueHolderf0992;

        return $this->valueHolderf0992->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer6e0ac = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolderf0992) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolderf0992 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolderf0992->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer6e0ac && ($this->initializer6e0ac->__invoke($valueHolderf0992, $this, '__get', ['name' => $name], $this->initializer6e0ac) || 1) && $this->valueHolderf0992 = $valueHolderf0992;

        if (isset(self::$publicProperties17a60[$name])) {
            return $this->valueHolderf0992->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolderf0992;
    ...
    {
        $this->initializer6e0ac && ($this->initializer6e0ac->__invoke($valueHolderf0992, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer6e0ac) || 1) && $this->valueHolderf0992 = $valueHolderf0992;
    ...
    {
        $this->initializer6e0ac && ($this->initializer6e0ac->__invoke($valueHolderf0992, $this, '__isset', array('name' => $name), $this->initializer6e0ac) || 1) && $this->valueHolderf0992 = $valueHolderf0992;
    ...
    {
        $this->initializer6e0ac && ($this->initializer6e0ac->__invoke($valueHolderf0992, $this, '__unset', array('name' => $name), $this->initializer6e0ac) || 1) && $this->valueHolderf0992 = $valueHolderf0992;
    ...
    {
        $this->initializer6e0ac && ($this->initializer6e0ac->__invoke($valueHolderf0992, $this, '__clone', array(), $this->initializer6e0ac) || 1) && $this->valueHolderf0992 = $valueHolderf0992;

        $this->valueHolderf0992 = clone $this->valueHolderf0992;
    }

    public function __sleep()
    {
        $this->initializer6e0ac && ($this->initializer6e0ac->__invoke($valueHolderf0992, $this, '__sleep', array(), $this->initializer6e0ac) || 1) && $this->valueHolderf0992 = $valueHolderf0992;

        return array('valueHolderf0992');
    }
    ...
    {
        $this->initializer6e0ac = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer6e0ac;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer6e0ac && ($this->initializer6e0ac->__invoke($valueHolderf0992, $this, 'initializeProxy', array(), $this->initializer6e0ac) || 1) && $this->valueHolderf0992 = $valueHolderf0992;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolderf0992;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolderf0992;
    }
}
